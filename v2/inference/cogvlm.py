...
class CogVLM:
    def __init__(
        ...
        model = load_checkpoint_and_dispatch(
            model,
            path,  # typical, '~/.cache/huggingface/hub/models--THUDM--cogvlm-chat-hf/snapshots/balabala'
...
if __name__ == "__main__":
    ...
    model = CogVLM(args.model_name, args.local_tokenizer, image_first=args.image_first)
    if args.image_first:
